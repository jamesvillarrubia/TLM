...
class PeThemeAsset {
	...
	public function registerAssets() {
		...
		$this->addScript("framework/js/pe/jquery.pixelentity.video.js",
						 apply_filters("pe_theme_video_js_deps",
						 array(
		...
		//wp_localize_script("pe_theme_video", 'peFallBackPlayer',array("url"=>urlencode(PE_THEME_URL."/framework/js/video/jarisplayer.swf")));
		...
		//$this->addScript("framework/js/prettyphoto/jquery.prettyPhoto.min.js",array("jquery"),"pe_theme_prettyphoto");
		//$this->addStyle("framework/css/video/video.css",array(),"pe_theme_video");
		$this->addStyle("framework/css/video/style.css",array(),"pe_theme_video");

		$this->addStyle("framework/js/prettyphoto/css/prettyPhoto.css",array("pe_theme_projekktor","pe_theme_video"),"pe_theme_prettyphoto");
		...
		$this->addStyle("framework/js/pe.flare/themes/default/skin.css",
						apply_filters("pe_theme_flare_css_deps",
						array(
							  "pe_theme_projekktor",
	...
	public static function addScript($res,$deps = NULL,$name = NULL,$footer = true) {
		self::addAsset("script",$res,$deps,$name,is_admin() ? false : true);
	}
	...
	public function enqueueAssets() {
		...
		if (!$this->minifyCSS) {
			wp_enqueue_style("pe_theme_prettyphoto");
		}
