...
class PeThemeMetaBox {
	...
	protected function registerAssets() {
		PeThemeAsset::addScript("framework/js/admin/jquery.theme.metabox.js",array("pe_theme_utils"),"pe_theme_metabox");
	}
	...
	public function render($post) {
		echo strtr($this->form->getHTML(),array("[CLASSES]"=>$this->getClasses($post->post_type)));
	}
