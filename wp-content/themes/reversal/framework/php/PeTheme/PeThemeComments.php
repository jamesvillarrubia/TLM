...
?>
		...
		<div class="row-fluid comment-body" id="div-comment-<?php echo $id ?>">
			...
			<div class="span11">
				...
				<span class="comment-awaiting-moderation"><?php echo __pe('Your comment is awaiting moderation.') ?></span>
				<br/>
				<?php endif; ?>
			

				<?php printf(__pe('<cite class="fn">%s</cite> <span class="says">says:</span>'), get_comment_author_link()); ?>
				<div class="comment-meta commentmetadata">
				<a href="<?php echo htmlspecialchars(get_comment_link()); ?>">
					<?php printf( __pe('%1$s at %2$s'), get_comment_date(),  get_comment_time()); ?>
				</a>
				<?php edit_comment_link(__pe('(Edit)'),'&nbsp;&nbsp;',''); ?>
				</div>
				<?php comment_text(); ?>
...
class Walker_Comment_PE extends Walker_Comment {
	...
	function start_lvl(&$output, $depth = 0, $args = Array()) {
		...
		echo '<div class="row-fluid"><div class="span11 pe-offset1 offset1"><ul class="children">';
	}
