...
<div id="respond">
	...
	<div class="row-fluid">
		<div class="span12">
			<h3 id="reply-title"><?php echo __pe("Leave A Comment") ?> <div class="pull-right"><?php cancel_comment_reply_link(__pe("Cancel Reply")); ?></div></h3>
		</div>
	</div>
	...
	<div class="row-fluid">
		<div class="span12">
			<form action="<?php $comments->action(); ?>" method="post" id="commentform" class="form-horizontal">
				...
				<?php else: ?>
				<p class="comment-notes"><?php echo __pe('Your email address will not be published. Required fields are marked'); ?> <span class="required">*</span></p>
				<div class="comment-form-author control-group">
					
					<div class="controls">
						<input class="span4" id="author" name="author" type="text" value="" size="30" aria-required="true"/>
					</div>
					<label class="control-label" for="author"><?php e__pe("Name"); ?> <span class="required">*</span></label>
				</div>
				...
				<div class="comment-form-email control-group">
					...
					<label class="control-label" for="email"><?php e__pe("Email"); ?> <span class="required">*</span></label>
				</div>
				...
				<div class="comment-form-url control-group">
					...
					<label class="control-label" for="url"><?php e__pe("Website"); ?></label>
				</div>
				<?php endif; ?>
				...
				<div class="comment-form-comment control-group">
					<div class="controls">
						...
						<textarea class="span7" id="comment" name="comment" cols="45" rows="8" aria-required="true" placeholder="<?php e__pe("Your comment here.."); ?>"></textarea>
					</div>
				</div>
				
				<div class="form-submit">
					<div class="controls">
						<button class="btn <?php echo apply_filters("pe_theme_comment_submit_class","btn-success"); ?>" type="submit"><?php e__pe("Post Comment"); ?></button>
						<?php $comments->fields(); ?>
					</div>
				</div>
			</form>
