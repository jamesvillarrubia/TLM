...
"Background images.",
"Intro Title",
"Define intro page title.",
"Welcome to <span>Reversal</span>",
"Leave empty to hide.",
"Fusce sollicitudin, dolor sed consectetur aliquet.<br>Lorem dolor viverra elit, quis interdum ligula turpis sit amet urna.",
"Label Text",
"If empty, hides the label.",
"Get Started <i class=\"icon-angle-right\"></i>",
"Label Url",
"About",
"Show Skills",
"If set to \"NO\", whole skills section will be hidden.",
"Skills Title",
"Heading displayed above skills, leave empty to hide.",
"Skill 1",
"Skill 1 text",
"Skill 1 amount",
"Skill 1 amount (min = 0, max = 100)",
"Skill 2",
"Skill 2 text",
"Skill 2 amount",
"Skill 2 amount (min = 0, max = 100)",
"Skill 3",
"Skill 3 text",
"Skill 3 amount",
"Skill 3 amount (min = 0, max = 100)",
"Skill 4",
"Skill 4 text",
"Skill 4 amount",
"Skill 4 amount (min = 0, max = 100)",
"Skill 5",
"Skill 5 text",
"Skill 5 amount",
"Skill 5 amount (min = 0, max = 100)",
"Displayed above services. Leave empty to hide.",
"Intro Button Text",
"Text of the button in intro section. Leave empty to hide.",
"Intro Button Link",
"Url a button will link to.",
"Add one or more services.",
"Contact Options",
"Contact Info.",
"Social Profile Links",
"Add the link to your social media profiles. Paste links one at a time and click the 'Add New' button. The links will appear in a table below and an icons will be inserted automatically based on the domain in the url.",
"Search..",
"Go",
"Your lovely Name",
"Tell us everything",
